...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_set_path', default='data/resAttention/train')
    parser.add_argument('--val_set_path', default="data/resAttention/valid")
    parser.add_argument('--test_set_path', default="data/resAttention/test")
    ...
    PATH = "model_zoo/your_model_zoo/attention_tcn.pth" # Saving directory for trained model
